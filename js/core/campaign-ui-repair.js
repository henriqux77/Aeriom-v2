(() => {
  "use strict";
  function loadStyles(){if(document.getElementById("aeriom-campaign-repair-css"))return;const link=document.createElement("link");link.id="aeriom-campaign-repair-css";link.rel="stylesheet";link.href="./css/campaign-repair.css?v=20260911-clean3";document.head.appendChild(link);}
  ...
  function loadAtmosphere(){if(window.__AERIOM_ATMOSPHERE_BOOT__)return;window.__AERIOM_ATMOSPHERE_BOOT__=true;Promise.allSettled([
    import("./atmosphere-ui.js?v=20260911-clean5"),
    import("./campaign-theme-runtime-clean.js?v=20260911-runtime1"),
    import("./campaign-theme-guard.js?v=20260911-guard1"),
    import("./campaign-cinematic-clean.js?v=20260911-clean1")
