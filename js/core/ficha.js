(() => {
  ...
  function rollPower(){var r=Math.floor(Math.random()*100)+1,p=r<=25?'Fogo':r<=50?'Terra':r<=75?'Água':'Ar';var masters={Fogo:{species:'Pequeno Dragão',image:'https://i.ibb.co/Y7Wbw3PY/file-000000000d44820e96b63eab4655b189.png'},Terra:{species:'Tartaruga',image:'https://i.ibb.co/Ndt9106B/file-00000000de18820ea959e3f6b2bcfafd.png'},Água:{species:'Polvo',image:'https://i.ibb.co/Psn3SPTs/file-00000000f894820e8433f2f40b4c188b.png'},Ar:{species:'Grifo',image:'https://i.ibb.co/r2XVnVWL/file-00000000a8a4820e907177fd92724e5c.png'}};var m=masters[p];state.powerRoll=r;state.primaryPower=p;state.powerMode='d100';state.customPowerDescription='';state.elementalMaster=Object.assign({},state.elementalMaster,{element:p,species:m.species,image:m.image});commit('aerion:power:selected');toast('D100: '+r+' — '+p+' · '+m.species+'.','success');return{roll:r,power:p,master:m.species};}
