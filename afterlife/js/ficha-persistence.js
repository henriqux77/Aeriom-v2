...
(() => {
  ...
  async function finalize(){
    ...
    try{
      ...
      await aeriom.rpc('advance_character_survival',{p_character_id:draftId,p_hunger_delta:0,p_thirst_delta:0,p_fatigue_delta:0,p_stress_delta:0,p_temperature:37,p_contamination_delta:0}).catch(()=>{});
