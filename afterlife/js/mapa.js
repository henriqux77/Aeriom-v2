...
(() => {
  ...
  const iconByCategory = c => ({
    ...
    electronics:'📱',computer:'💻',mobile_phone:'📱',books:'📚',stationery:'✏️',copyshop:'🖨️',print_shop:'🖨️',
    clothes:'👕',shoes:'👟',jewelry:'💍',beauty:'💄',hairdresser:'💈',cosmetics:'💄',laundry:'🧺',dry_cleaning:'🧥',
    tattoo:'🖋️',massage:'💆',perfumery:'🌹',
    bicycle:'🚲',car:'🚗',car_parts:'⚙️',car_repair:'🔧',motorcycle:'🏍️',tyres:'🛞',
    travel_agency:'🧳',insurance:'🛡️',mobile_phone:'📱',computer:'💻',musical_instrument:'🎸',
    funeral_directors:'⚰️',gift:'🎁',toys:'🧸',sports:'🏅',outdoor:'🥾',
    mall:'🏬',hotel:'🏨',hostel:'🛏️',motel:'🛏️',camp_site:'⛺',
    park:'🌳',playground:'🛝',garden:'🌿',forest:'🌲',nature_reserve:'🌲',beach_resort:'🏖️',
    school:'🏫',university:'🎓',kindergarten:'🧸',college:'🎓',language_school:'🗣️',driving_school:'🚙',
    ...
    office:'🏢',government:'🏛️',townhall:'🏛️',courthouse:'⚖️',community_centre:'🏘️',lawyer:'⚖️',accountant:'🧮',architect:'📐',it:'💻',estate_agent:'🏠',
    plumber:'🔧',electrician:'⚡',carpenter:'🪚',tailor:'🧵',shoemaker:'👞',blacksmith:'⚒️',photographer:'📷',
    warehouse:'📦',industrial:'🏭',factory:'🏭',construction:'🚧',
    tourist_information:'ℹ️',information:'ℹ️',viewpoint:'🔭',attraction:'🎟️',artwork:'🎨',zoo:'🦁',aquarium:'🐠',theme_park:'🎢',
    lighthouse:'🗼',water_tower:'🚰',water_well:'🪣',fire_hydrant:'🚒',marina:'⚓',
    recycling:'♻️',waste_basket:'🗑️',toilets:'🚻',drinking_water:'🚰',shower:'🚿',bench:'🪑',
    dog_park:'🐕',fishing:'🎣',picnic_table:'🧺',
  ...
  function openSheet(kind){
    ...
    let t='Painel',html='';
    if(kind==='party'){t='Personagens';html='<div class="sheet-section"><div class="sheet-section-title">PERSONAGENS NA CAMPANHA</div><div class="sheet-party">'+state.characters.map(ch=>'<div class="sheet-card"><strong>'+esc(ch.name||'Sobrevivente')+'</strong><small>'+esc(ch.class||'Sobrevivente')+' · '+esc(ch.race||'Humano')+' · '+(validCharacterPoint(ch)?'posição ativa':'sem posição')+'</small></div>').join('')+'</div></div>';}
  ...
  function drawPois(items){
    ...
    [...normal,...houses].forEach(p=>{
      ...
      const m=L.marker([p.lat,p.lng],{icon:mapIcon(iconByCategory(category),isHouse?'house':'poi',markerLabel(p.name,isHouse?'Casa':category)),zIndexOffset:isHouse?40:60}).addTo(state.layer.pois);
